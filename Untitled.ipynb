{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "            ARRESTTIME                                           OFFENSES  \\\n",
       "0  2016-08-24T12:20:00                                 3929 Retail Theft.   \n",
       "1  2016-08-03T14:55:00       13(a)(16) Possession of Controlled Substance   \n",
       "2  2016-08-03T16:45:00                                 3929 Retail Theft.   \n",
       "3  2016-08-05T02:36:00  5503 Disorderly Conduct. / 5505 Public Drunken...   \n",
       "4  2016-08-06T02:00:00  2702 Aggravated Assault. / 2705 Recklessy Enda...   \n",
       "\n",
       "           X          Y  \n",
       "0 -79.949277  40.452551  \n",
       "1 -80.088018  40.440136  \n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Before we do that, I wanted to give an idea of how many arrests there were within the entire CSV file. This will allow us to compare percentages easier. "
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "    name = geo_to_neighborhood(row[\"X\"], row[\"Y\"])\n",
    "    if name == None:\n",
    "        continue\n",
    "    arresttable[name] = 0\n",
    "    \n",
    ...
    "    if name == None:\n",
    "        continue\n",
    "    arresttable[name] = arresttable[name] + 1 or 1\n",
    "        \n",
    "for i in arresttable:\n",
    "    print(i + \": \" + str(arresttable[i]))\n",
    "    print(\"--------\")"
   ]
  },
  {
